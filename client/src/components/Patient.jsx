  ...
  const retrieveHealthID = async () => {
    ...
    try {
      await state.healthidmContract.methods
        .getHealthId(account[0], "PATIENT")
        .call({ from: account[0] })
        .then(function (result) {
          console.log("is HealthID exist for patient : :", result);
          if (result != nullHealthId) {
            ...
            try {
              state.healthidmContract.methods
                ...
                .call({ from: account[0] })
                .then(function (result) {
                  console.log("Reslut.state :", result.state);
                  console.log("Reslut.owner_type :", result.ownerType);
